...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~mypyrogram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.DeletedMessagesHandler(func, self),
