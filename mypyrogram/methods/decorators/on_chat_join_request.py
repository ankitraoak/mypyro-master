...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~mypyrogram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.ChatJoinRequestHandler(func, self),
