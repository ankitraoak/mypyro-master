...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~mypyrogram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.ChatMemberUpdatedHandler(func, self),
