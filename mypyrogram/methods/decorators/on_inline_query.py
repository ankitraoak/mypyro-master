...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~mypyrogram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.InlineQueryHandler(func, self),
