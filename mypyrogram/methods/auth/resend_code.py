...
class ResendCode:
    async def resend_code(
        ...
        :obj:`~mypyrogram.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~mypyrogram.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
