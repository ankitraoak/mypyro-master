...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~mypyrogram.Client.stop` and then :meth:`~mypyrogram.Client.start` in a row in
        ...
        Returns:
            :obj:`~mypyrogram.Client`: The restarted client itself.
