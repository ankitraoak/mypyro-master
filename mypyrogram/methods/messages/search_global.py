...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~mypyrogram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~mypyrogram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~mypyrogram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "mypyrogram". Get the first 50 results
                async for message in app.search_global("mypyrogram", limit=50):
                    print(message.text)
