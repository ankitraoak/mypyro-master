...
from mypyrogram.errors import AuthBytesInvalid
from mypyrogram.session import Session
from mypyrogram.session.auth import Auth


async def get_session(client: "mypyrogram.Client", dc_id: int):
