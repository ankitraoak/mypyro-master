...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~mypyrogram.types.InputMediaPhoto`, :obj:`~mypyrogram.types.InputMediaVideo`, :obj:`~mypyrogram.types.InputMediaAudio` and :obj:`~mypyrogram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~mypyrogram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from mypyrogram.types import InputMediaPhoto, InputMediaVideo
