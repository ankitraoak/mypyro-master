...
import mypyrogram
from mypyrogram import StopTransmission, enums
from mypyrogram import raw
from mypyrogram import types
from mypyrogram import utils
from mypyrogram.errors import FilePartMissing
from mypyrogram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~mypyrogram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~mypyrogram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~mypyrogram.Client.stop_transmission`, None is returned.
