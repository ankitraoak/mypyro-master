...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~mypyrogram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~mypyrogram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~mypyrogram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~mypyrogram.types.CallbackGame`, *optional*):
