...
class BotCommandScope(Object):
    ...
    - :obj:`~mypyrogram.types.BotCommandScopeDefault`
    - :obj:`~mypyrogram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~mypyrogram.types.BotCommandScopeAllGroupChats`
    - :obj:`~mypyrogram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~mypyrogram.types.BotCommandScopeChat`
    - :obj:`~mypyrogram.types.BotCommandScopeChatAdministrators`
    - :obj:`~mypyrogram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "mypyrogram.Client") -> "raw.base.BotCommandScope":
