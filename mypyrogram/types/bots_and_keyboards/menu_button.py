...
class MenuButton(Object):
    ...
    - :obj:`~mypyrogram.types.MenuButtonCommands`
    - :obj:`~mypyrogram.types.MenuButtonWebApp`
    - :obj:`~mypyrogram.types.MenuButtonDefault`

    If a menu button other than :obj:`~mypyrogram.types.MenuButtonDefault` is set for a private chat, then it is applied
    ...
    async def write(self, client: "mypyrogram.Client") -> "raw.base.BotMenuButton":
