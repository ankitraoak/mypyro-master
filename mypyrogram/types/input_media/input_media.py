...
class InputMedia(Object):
    ...
    - :obj:`~mypyrogram.types.InputMediaAnimation`
    - :obj:`~mypyrogram.types.InputMediaDocument`
    - :obj:`~mypyrogram.types.InputMediaAudio`
    - :obj:`~mypyrogram.types.InputMediaPhoto`
    - :obj:`~mypyrogram.types.InputMediaVideo`
    """
