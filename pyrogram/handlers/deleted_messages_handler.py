...
from mypyrogram.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~mypyrogram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~mypyrogram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~mypyrogram.types.Message`):
    ...
    async def check(self, client: "mypyrogram.Client", messages: List[Message]):
