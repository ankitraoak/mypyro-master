...
from mypyrogram.crypto import aes, rsa, prime
from mypyrogram.errors import SecurityCheckMismatch
from mypyrogram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "mypyrogram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
