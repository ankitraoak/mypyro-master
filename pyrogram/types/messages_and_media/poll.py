...
import mypyrogram
from mypyrogram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~mypyrogram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~mypyrogram.types.MessageEntity`, *optional*):
