...
class InlineQuery(Object, Update):
    ...
    Parameters:
        ...
        chat_type (:obj:`~mypyrogram.enums.ChatType`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the query of this inline query. Only applicable when using :obj:`Filters.regex <mypyrogram.Filters.regex>`.
    """
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~mypyrogram.types.InlineQuery`.
        ...
        Parameters:
            results (List of :obj:`~mypyrogram.types.InlineQueryResult`):
