...
class Object:
    def __init__(self, client: "mypyrogram.Client" = None):
        self._client = client

    def bind(self, client: "mypyrogram.Client"):
        """Bind a Client instance to this and to all nested mypyrogram objects.

        Parameters:
            client (:obj:`~mypyrogram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing mypyrogram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/mypyrogramchat/167281
    ...
    def __repr__(self) -> str:
        return "mypyrogram.types.{}({})".format(
