...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        chat (:obj:`~mypyrogram.types.Chat`):
        ...
        invite_link (:obj:`~mypyrogram.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~mypyrogram.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~mypyrogram.types.ChatJoinRequest`.
