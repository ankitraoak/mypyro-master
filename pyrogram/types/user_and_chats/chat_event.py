...
from mypyrogram import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        action (:obj:`~mypyrogram.enums.ChatEventAction`):
            Event action.

        user (:obj:`~mypyrogram.types.User`):
            User that triggered the event.

        old_description, new_description (``str``, *optional*):
            Previous and new chat description.
            For :obj:`~mypyrogram.enums.ChatEventAction.DESCRIPTION_CHANGED` action only.

        old_history_ttl, new_history_ttl (``int``, *optional*):
            Previous and new chat history TTL.
            For :obj:`~mypyrogram.enums.ChatEventAction.HISTORY_TTL_CHANGED` action only.

        old_linked_chat, new_linked_chat (:obj:`~mypyrogram.types.Chat`, *optional*):
            Previous and new linked chat.
            For :obj:`~mypyrogram.enums.ChatEventAction.LINKED_CHAT_CHANGED` action only.

        old_photo, new_photo (:obj:`~mypyrogram.types.Photo`, *optional*):
            Previous and new chat photo.
            For :obj:`~mypyrogram.enums.ChatEventAction.PHOTO_CHANGED` action only.

        old_title, new_title (``str``, *optional*):
            Previous and new chat title.
            For :obj:`~mypyrogram.enums.ChatEventAction.TITLE_CHANGED` action only.

        old_username, new_username (``str``, *optional*):
            Previous and new chat username.
            For :obj:`~mypyrogram.enums.ChatEventAction.USERNAME_CHANGED` action only.

        old_chat_permissions, new_chat_permissions (:obj:`~mypyrogram.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For :obj:`~mypyrogram.enums.ChatEventAction.CHAT_PERMISSIONS_CHANGED` action only.

        deleted_message (:obj:`~mypyrogram.types.Message`, *optional*):
            Deleted message.
            For :obj:`~mypyrogram.enums.ChatEventAction.MESSAGE_DELETED` action only.

        old_message, new_message (:obj:`~mypyrogram.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For :obj:`~mypyrogram.enums.ChatEventAction.MESSAGE_EDITED` action only.

        invited_member (:obj:`~mypyrogram.types.ChatMember`, *optional*):
            New invited chat member.
            For :obj:`~mypyrogram.enums.ChatEventAction.MEMBER_INVITED` action only.

        old_administrator_privileges, new_administrator_privileges (:obj:`~mypyrogram.types.ChatMember`, *optional*):
            Previous and new administrator privileges.
            For :obj:`~mypyrogram.enums.ChatEventAction.ADMINISTRATOR_PRIVILEGES_CHANGED` action only.

        old_member_permissions, new_member_permissions (:obj:`~mypyrogram.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For :obj:`~mypyrogram.enums.ChatEventAction.MEMBER_PERMISSIONS_CHANGED` action only.

        stopped_poll (:obj:`~mypyrogram.types.Message`, *optional*):
            Message containing the stopped poll.
            For :obj:`~mypyrogram.enums.ChatEventAction.POLL_STOPPED` action only.

        invites_enabled (``bool``, *optional*):
            If chat invites were enabled (True) or disabled (False).
            For :obj:`~mypyrogram.enums.ChatEventAction.INVITES_ENABLED` action only.

        history_hidden (``bool``, *optional*):
            If chat history has been hidden (True) or unhidden (False).
            For :obj:`~mypyrogram.enums.ChatEventAction.HISTORY_HIDDEN` action only.

        signatures_enabled (``bool``, *optional*):
            If message signatures were enabled (True) or disabled (False).
            For :obj:`~mypyrogram.enums.ChatEventAction.SIGNATURES_ENABLED` action only.

        old_slow_mode, new_slow_mode (``int``, *optional*):
            Previous and new slow mode value in seconds.
            For :obj:`~mypyrogram.enums.ChatEventAction.SLOW_MODE_CHANGED` action only.

        pinned_message (:obj:`~mypyrogram.types.Message`, *optional*):
            Pinned message.
            For :obj:`~mypyrogram.enums.ChatEventAction.MESSAGE_PINNED` action only.

        unpinned_message (:obj:`~mypyrogram.types.Message`, *optional*):
            Unpinned message.
            For :obj:`~mypyrogram.enums.ChatEventAction.MESSAGE_UNPINNED` action only.

        old_invite_link, new_invite_link (:obj:`~mypyrogram.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For :obj:`~mypyrogram.enums.ChatEventAction.INVITE_LINK_EDITED` action only.

        revoked_invite_link (:obj:`~mypyrogram.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For :obj:`~mypyrogram.enums.ChatEventAction.INVITE_LINK_REVOKED` action only.

        deleted_invite_link (:obj:`~mypyrogram.types.ChatInviteLink`, *optional*):
            Deleted invite link.
            For :obj:`~mypyrogram.enums.ChatEventAction.INVITE_LINK_DELETED` action only.
    """
