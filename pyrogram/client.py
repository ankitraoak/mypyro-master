...
import mypyrogram
from mypyrogram import __version__, __license__
from mypyrogram import enums
from mypyrogram import raw
from mypyrogram import utils
from mypyrogram.crypto import aes
from mypyrogram.errors import CDNFileHashMismatch
from mypyrogram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from mypyrogram.handlers.handler import Handler
from mypyrogram.methods import Methods
from mypyrogram.session import Auth, Session
from mypyrogram.storage import FileStorage, MemoryStorage
from mypyrogram.types import User, TermsOfService
from mypyrogram.utils import ainput
...
class Client(Methods):
    """mypyrogram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~mypyrogram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where mypyrogram will store the session files.
    ...
    APP_VERSION = f"mypyrogram {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to mypyrogram (version {__version__})")
        print(f"mypyrogram is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~mypyrogram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.mypyrogram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except mypyrogram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
