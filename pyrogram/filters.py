...
from mypyrogram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "mypyrogram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~mypyrogram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~mypyrogram.handlers.MessageHandler` the *update* argument will be a :obj:`~mypyrogram.types.Message`; in a :obj:`~mypyrogram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~mypyrogram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~mypyrogram.filters.command` or :meth:`~mypyrogram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~mypyrogram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~mypyrogram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~mypyrogram.types.Message`.
    ...
    async def func(flt, client: mypyrogram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~mypyrogram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~mypyrogram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~mypyrogram.types.InlineQuery`: The filter will match ``query``.
