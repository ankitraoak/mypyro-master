...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~mypyrogram.types.Chat` | :obj:`~mypyrogram.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("mypyrogram")
                print(chat)
        """
