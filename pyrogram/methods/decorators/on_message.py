...
class OnMessage:
    def on_message(
        ...
        :obj:`~mypyrogram.handlers.MessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.MessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.MessageHandler(func, self),
