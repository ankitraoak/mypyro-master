...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~mypyrogram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.UserStatusHandler(func, self),
