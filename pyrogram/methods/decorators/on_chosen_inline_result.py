...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~mypyrogram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.ChosenInlineResultHandler(func, self),
