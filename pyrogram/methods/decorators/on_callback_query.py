...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~mypyrogram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, mypyrogram.Client):
                self.add_handler(mypyrogram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        mypyrogram.handlers.CallbackQueryHandler(func, self),
