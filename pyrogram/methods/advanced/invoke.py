...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <mypyrogram.api.functions>` package and may accept compound
        data types from :obj:`types <mypyrogram.api.types>` as well as bare types such as ``int``, ``str``, etc...
