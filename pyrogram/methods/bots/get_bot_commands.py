...
import mypyrogram
from mypyrogram import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~mypyrogram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~mypyrogram.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~mypyrogram.types.BotCommand`: On success, the list of bot commands is returned.
