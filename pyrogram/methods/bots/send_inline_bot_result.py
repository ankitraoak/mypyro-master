...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~mypyrogram.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~mypyrogram.raw.base.Updates`: Currently, on success, a raw result is returned.
