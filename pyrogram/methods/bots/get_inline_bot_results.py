...
from mypyrogram.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~mypyrogram.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <mypyrogram.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("mypyrogrambot")
                print(results)
        """
