...
from mypyrogram.errors import PhoneMigrate, NetworkMigrate
from mypyrogram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~mypyrogram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
