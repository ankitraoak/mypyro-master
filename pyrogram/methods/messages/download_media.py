...
from mypyrogram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~mypyrogram.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~mypyrogram.Client.stop_transmission`, None is returned.
